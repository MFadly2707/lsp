...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-brand">
            ...
            <h4 class="text-brand">Printer Market</h4>
        </div>
        <ul class="navbar-nav">
            <li class="nav-item">
    ...
    <div class="row">
        <div class="card mt-5">
            ...
            <br>
            <div class="row-btn">
                <a href="../index.php" class="btn btn-info">Lanjut Berbelanja</a>
                <?php 
    
            if (isset($_SESSION['id_user'])) {
            ?>
                <a href="checkout.php" class="btn btn-primary" onclick="return confirm('Apakah Kamu Yakin Ingin Checkout?')">Checkout</a>
                <?php } 
