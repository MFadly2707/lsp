...
<div class="keranjang-belanja container mt-3">
        ...
        <?php foreach ($_SESSION["cart"] as $id_barang => $kuantitas) : ?>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary my-2" href="edit_keranjang.php?id=<?= $data["id_barang"]; ?>"><i class="fa-solid fa-pen"></i></a>
                    <a class="btn btn-danger my-2" href="hapus_keranjang.php?id=<?= $data["id_barang"]; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Produk Ini Dari Keranjang?')"><i class="fa-solid fa-trash"></i></a>
                </td>
            </tr>
        <?php endforeach; ?>
        <tr>
